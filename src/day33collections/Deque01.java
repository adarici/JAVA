...
public class Deque01 {
	...
	/*
	 	1)Dequeue stands for Double Ended Queue
	 	2)We can use FIFO and LIFO together in Dequeue
	...
	public static void main(String[] args) {
		...
		// How can you verify if a specific element is repeated in a Dequeue or not?
