...
public class ForEachLoop01 {
	...
	public static void main(String[] args) {
		...
		//If you see any character whose ASCII value is less than 100 
		//stop printing and give an error message
		...
		System.out.println();
// Arrays can use for-each as well
	// Print the list elements does not end with "n"	
