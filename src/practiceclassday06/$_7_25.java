...
(During this process JVM assigns default value for each variable at the time of declaration)
 ...
 //-----------------------------Static Control Flow in multiple classes---------------------------\\
    ...
    and off course from top to bottom.
    
    3) Execution of main method of the child. if child class does not have one main method 
    then parent's main method will be executed. 

****Important Note: Now, if u run the parent class only parent will be executed 
*child class will not be loaded nor will be executed. because parent class members by default available
 ...
 * Whenever u create a child object following will occur;
 ...
 0) static control flow will be executed from parent to child 
 (if there is object creation(IN CHILD CLASS) then go to next 
 if NOT then u stop)
 1) Identification of instance members from parent to child 
 and off course top to bottom (During this process JVM assigns 
 default value for each variable at the time of declaration)
  
  PARENT ONLY;
 2) Execution of instance variable assignments and instance blocks from 
 top to bottom in PARENT CLASS
 3) Execution of constructor in PARENT CLASS.
 
    CHILD ONLY;
 4) Execution of instance variable assignments and instance blocks from 
 top to bottom in CHILD CLASS
 5) Execution of constructor in CHILD CLASS.

 ****Important Note: Now, if u run the parent class only parent will be 
 executed child class will not be loaded nor will be executed. 
 ...
 */
public class $_7_25 {
	// JVM create automatically one thread for each class. this is called main thread.
	String name; //null
	int age; //0
 $_7_25(String name, int age){// local variables. their scope is limited with in constructor.
...
$_7_25 obj = new $_7_25("Ali", 43);
$_7_25 obj1 = new $_7_25("Afra", 40);
