...
/*
Minutes Mountain Array ==> [0, 2, 5, 3, 1,0] It is constantly increasing to
...
public class Iq06 {
	...
	public static void checkArrayToBeMountain(){
		...
		//1.Step
				...
				// 2. Step
			// Get the first part==> Sort the element in ascending order ==> Compare the sorted list with the original list	
	...
	Collections.sort(sortedPart1List);
		...
		boolean isTheFirstPartOk = sortedPart1List.equals(sortedPart1List);
